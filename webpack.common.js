  ...
  return {
    ...
    plugins: [
      ...
      /**
         ...
         */
      /(.+)?angular(\\|\/)core(.+)?/, helpers.root('src'), { // location of your src
        /**
      ...
      */
      ...
      HtmlWebpackPlugin({
        ...
        chunksSortMode: function(a, b) {const
          entryPoints = [
            "inline",
            "polyfills",
            "sw-register",
       ...
       */
      new
      ScriptExtHtmlWebpackPlugin({sync: /polyfills|vendor/,defaultAttribute: 'async', preload: [/polyfills|vendor|main/],prefetch: [/chunk/]}),
       ...
       */
      new
      HtmlElementsPlugin({headTags: require('./head-config.common')}),
      ...
      ngcWebpack. NgcWebpackPlugin({
         ...
         * @default true
         */disabled: ! AOT, tsConfig: helpers. root('tsconfig.webpack.json')
      }),
